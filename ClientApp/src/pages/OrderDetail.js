...
import { formatNumberToVietNamCurrency, getOrderById } from "../utils/common";
              ...
              <section>
                <div className={styles["user-infor"]}>
                  ...
                  <ul className={styles["content-infor"]}>
                    ...
                    <li>
                      Total:{" "}
                      {formatNumberToVietNamCurrency(orderDetail.totalAmount)}
                    </li>
                  </ul>
                </div>
              </section>
                    ...
                    {orderDetail.products.map((item, index) => (
                      ...
                      >
                        ...
                        <div className={`${styles["price"]}`}>
                          {formatNumberToVietNamCurrency(item.productId.price)}
                        </div>
